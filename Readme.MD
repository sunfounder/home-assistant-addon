...
```bash
docker build . --build-arg BUILD_FROM=ghcr.io/hassio-addons/ubuntu-base/aarch64:10.0.4 -t sunfounder/aarch64-pironman5:1.2.3
...
```bash
docker tag sunfounder/aarch64-pironman5:1.2.3 sunfounder/aarch64-pironman5:latest
...
```bash
docker push sunfounder/aarch64-pironman5:1.2.3
